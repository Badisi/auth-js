...
`],encapsulation:3})}});var Yt,kn,In=S(()=>{"use strict";qt();Sn();An();Yt=ke({validator:un()}),kn=[{path:"",component:ct,children:[{path:"forbidden",loadComponent:()=>import("./chunk-MMGSIZBA.js").then(t=>t.PageComponent),runGuardsAndResolvers:"always",data:{title:"ACCESS FORBIDDEN"}},{path:"public",loadComponent:()=>import("./chunk-MMGSIZBA.js").then(t=>t.PageComponent),runGuardsAndResolvers:"always",data:{title:"PUBLIC CONTENT"}},{path:"private",loadComponent:()=>import("./chunk-MMGSIZBA.js").then(t=>t.PageComponent),runGuardsAndResolvers:"always",canMatch:[ke()],canActivate:[ke()],canActivateChild:[ke()],data:{title:"PRIVATE CONTENT"}},{path:"protected",loadComponent:()=>import("./chunk-MMGSIZBA.js").then(t=>t.PageComponent),runGuardsAndResolvers:"always",canMatch:[Yt],canActivate:[Yt],canActivateChild:[Yt],data:{title:"PROTECTED CONTENT"}}]}]});var Wl,Nr=S(()=>{"use strict";In();Wl=[{path:"",children:kn},{path:"**",pathMatch:"full",redirectTo:""}]});export{_r as a,br as b,qt as c,rn as d,Sn as e,Wl as f,Nr as g};
