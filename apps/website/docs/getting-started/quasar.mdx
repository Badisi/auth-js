...
This guide explains how to set up your [Quasar][quasar] project to begin using [@badisi/auth-vue][auth-vue].
...
An existing [Quasar][quasar-start] application set up with **TypeScript** and **Vite**.
...
[quasar-start]: https://quasar.dev/start/quick-start
