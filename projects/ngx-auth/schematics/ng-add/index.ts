...
import {
    addImportToFile, addImportToNgModule, application, ChainableApplicationContext,
    ...
    schematic('ngx-auth', [
        ...
        application(options.project)
            ...
            .rule(({ tree, project }: ChainableApplicationContext) => {
                ...
                const commonJsDeps = new JSONFile(tree, 'angular.json').get(commonJsDepsPath) as string[] ?? [];
