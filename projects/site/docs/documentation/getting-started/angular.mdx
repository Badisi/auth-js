...
3. Provide the library *(according to the type of your Angular application)*
    ...
    - By providing the library, an [`AuthService`](../../apis/angular/auth-service), [`AuthGuard`](../../apis/angular/auth-guard) and [`AuthInterceptor`](../../apis/angular/auth-interceptor) will be also provided to your application.
    :::
...
[ngx-auth]: https://github.com/badisi/auth-js/tree/main/projects/ngx-auth
