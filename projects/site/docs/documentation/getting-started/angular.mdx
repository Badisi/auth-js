...
4. Modify your **app.module.ts** file
    ...
    :::info
    Importing the **AuthModule** is required so an [`AuthService`](../../apis/angular/auth-service), [`AuthInterceptor`](../../apis/angular/auth-interceptor) and [`AuthGuard`](../../apis/angular/auth-guard) are provided to your application.
    :::
    <br/>
