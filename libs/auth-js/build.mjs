...
const copyAssets = async () => {
    await cpy('libs/auth-js/oidc/assets', pathResolve(CONFIG.distPath, 'oidc', 'assets'), { flat: true });
    await cpy('libs/auth-js/package.json', CONFIG.distPath, { flat: true });
    await cpy('libs/auth-js/README.md', CONFIG.distPath, { flat: true });
    await cpy('LICENSE', CONFIG.distPath, { flat: true });
    await cpy('node_modules/oidc-client-ts/LICENSE', pathResolve(CONFIG.distPath, 'browser', 'oidc'), {
